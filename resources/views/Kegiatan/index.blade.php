    ...
    <div class="row">
        ...
        <table class="table">
          ...
          @foreach ($data_kegiatan as $kegiatan)
              <tr>
                  <td>{{$kegiatan->donatur->nama_donatur}}</td>
                 ...
                 <td><a href="/deletekegiatan/{{$kegiatan->id}}" class="btn btn-danger btn-sm" >Delete</a></td>
              </tr>
          @endforeach
        ...
        <div class="modal-body">
                <form action="/Kegiatan/create" method="POST">
                  ...
                  <div class="form-group">
                    <label for="exampleInputPegawai">Donatur</label>
                    <select name="donatur_id" id="exampleInputPegawai">
                      @foreach ($data_donatur as $donatur)
                        <option value={{$donatur->id}}>{{$donatur->nama_donatur}}</option>
                      @endforeach
                    </select>
                  </div>
                  <div class="form-group">
